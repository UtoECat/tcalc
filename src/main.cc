...
<<"                          HELP :                       " << endl
<<"┌┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┐" << endl
<<"┊* Press E or E key to exit. This is simple terminal   ┊" << endl
<<"┊* calculator, writed in C++. It can calculate simple  ┊" << endl
<<"┊* mathematical expression like X + Y = ... It can аlso┊" << endl
<<"┊* multiply, divide , find perchange and other..You can┊" << endl
<<"┊* freely copy, distribute and modify this calculator, ┊" << endl
<<"┊* provided that you guarantee all these rights to other" << endl
<<"┊* users who will use your copy / modification, and you┊" << endl
<<"┊* also agree not to alter the authorship of this calc ┊" << endl
<<"┊* You can only identify yourself as a developer of a  ┊" << endl
<<"┊* modification or a distributor. Learn more about GNU:┊" << endl
<<"┊* www.gnu.org/licenses/gpl-3.0.ru.html                ┊" << endl
<<"┊   --Simple Terminal Calculator (GNU) By UtoECat--    ┊" << endl
<<"┊Version " << C_V <<"                                           ┊" << endl
<<"└┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┘" << endl
<<"C++ is cool!"<<endl;
}